...
public class Seeder {
    public static void seedDatabaseWithStartData() {
        ...
        Exercise ex1 = new Exercise("10", null, "Hoeveel is 5 + 5?", Category.MATH);
        Exercise ex2 = new Exercise("2003", "Zoek via wikipedia naar het correcte antwoord.", "In welk jaar is het boek De Davinci Code uitgegeven", Category.DUTCH);
