...
public class Seeder {
    public static void seedDatabaseWithStartData() {
        ...
        Exercise ex1 = new Exercise("RANDOM NAME", "10", null, "Hoeveel is 5 + 5?", Category.MATH, Arrays.asList(goArray));
        Exercise ex2 = new Exercise("ANOTHER RANDOM NAME", "2003", "Zoek via wikipedia naar het correcte antwoord.", "In welk jaar is het boek De Davinci Code uitgegeven", Category.DUTCH, Arrays.asList(goArray));
